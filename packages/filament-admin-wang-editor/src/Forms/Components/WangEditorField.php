...
namespace LaravelStack\FilamentAdminWangEditor\Forms\Components;
...
{
    /**
     * 字段渲染视图（filament-admin-wang-editor::components.wang-editor）
     */
    protected string $view = 'filament-admin-wang-editor::components.wang-editor';
