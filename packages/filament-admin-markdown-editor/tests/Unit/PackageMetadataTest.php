 ...
 * Markdown 编辑器包元信息测试
 *
 * 锁死 packages/filament-admin-markdown-editor/composer.json 的关键字段，
 * 确保插件市场契约（extra.filament-admin）完整有效。
 */
class PackageMetadataTest extends TestCase
{
    ...
    /**
     * 验证 extra.filament-admin 含必填字段，slug 值为 filament-admin-markdown-editor
     */
    public function test_extra_filament_admin_has_required_fields(): void
    {
        ...
        self::assertSame('filament-admin-markdown-editor', $meta['slug']);
    }
    ...
    public function test_laravel_provider_is_declared(): void
    {
        ...
        self::assertContains(
            'LaravelStack\\FilamentAdminMarkdownEditor\\MarkdownEditorServiceProvider',
            $providers,
        );
    }
    ...
    public function test_composer_json_is_valid(): void
    {
        ...
        self::assertSame('laravelstack/filament-admin-markdown-editor', $this->composer['name']);
    }
}
