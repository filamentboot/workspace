...
namespace Filamentboot\FilamentbootRichEditor\Forms;
 ...
 * $data['content'] = app(\Filamentboot\FilamentbootRichEditor\Support\RichEditorPurifier::class)->clean($data['content']);
