...
class SiteServiceProvider extends ServiceProvider
{
     ...
     *
     * 读取 SiteSettings.active_theme，将 'filamentboot-site' 视图命名空间根
     ...
     *
     * 额外注册共享视图命名空间（filamentboot-site-shared），使 Livewire 视图
     * resources/views/livewire/ 可通过 filamentboot-site::livewire.* 解析。
     *
