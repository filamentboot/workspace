 ...
 *
 * 本地：php artisan serve --port=8124 后
 *       npx playwright test site- --config=playwright.config.site.cjs
 * 线上：BASE_URL=https://你的域名 npx playwright test site- --config=playwright.config.site.cjs
 *
...
module.exports = defineConfig({
    ...
    use: {
        baseURL: process.env.BASE_URL || 'http://127.0.0.1:8124',
        headless: true,
    },
    projects: [
        {
