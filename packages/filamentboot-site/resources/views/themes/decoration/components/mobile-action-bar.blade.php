{{--
 * 移动端底部三段式操作条（decoration 深色主题，C1）
 *
...
<div x-data="{ qrOpen: false }" class="sm:hidden">
    ...
    @if($barQrcode)
        <div
            class="fixed inset-0 z-[70] bg-black/60 flex items-center justify-center px-8"
            x-show="qrOpen"
    ...
    {{-- 底部固定条 --}}
    <nav
        class="fixed bottom-0 left-0 right-0 z-[45] bg-site-surface/95 backdrop-blur-md border-t border-site
               flex items-stretch"
