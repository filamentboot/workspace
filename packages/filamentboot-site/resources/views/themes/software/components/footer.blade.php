...
@php
    ...
    // SiteFrontMenuSeeder::softwareMenus()['footer'] 天然一致（五期批次 4c 起
    // software 没有「服务城市」概念，「我们的服务」在这里换成「快速开始」，
    // 这两项不属于内容类型词表，仍然留字面量）。
    $quickLinks = app(\Filamentboot\FilamentbootSite\Cms\Services\MenuResolver::class)->resolveFlat('footer') ?? [
        ...
        ['href' => route('site.page', 'services'), 'label' => '快速开始'],
        ['href' => route('site.page', 'about'),   'label' => '关于我们'],
        ['href' => route('site.page', 'faq'),     'label' => '常见问题'],
        ['href' => route('site.page', 'community'), 'label' => '社区'],
