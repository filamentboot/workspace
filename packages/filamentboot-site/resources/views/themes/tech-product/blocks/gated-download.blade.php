...
<section class="py-16 bg-site-surface" @if($title !== '') aria-labelledby="{{ $headingId }}" @endif>
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div>
                <p class="text-site-accent text-xs font-semibold tracking-widest uppercase mb-3">免费资料</p>

                @if($title !== '')
                    <h2 id="{{ $headingId }}" class="text-site-primary text-2xl md:text-3xl font-semibold tracking-tight leading-tight mb-4">
                        {{ $title }}
                    </h2>
                @endif
            ...
            <div class="bg-site-base rounded-xl border border-site p-5 sm:p-6">
                <p class="text-site-primary font-semibold text-base mb-6">{{ $buttonLabel }}</p>
