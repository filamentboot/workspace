 ...
 * 资讯演示内容种子
 *
 * 选题不是凭空拟的：来自 docs/cms/jd-assets/reviews-insight.json 里聚合出的
...
class SiteNewsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($this->articlesData($categories) as $data) {
            ...
            $this->addCoverImage($article, 'site/news/'.$data['slug'].'.jpg');
    ...
    {
        return collect([
            ['name_zh' => '选型指南', 'name_en' => 'Buying Guide', 'slug' => 'xuan-xing-zhi-nan', 'sort' => 1],
            ['name_zh' => '装修攻略', 'name_en' => 'Renovation Tips', 'slug' => 'zhuang-xiu-gong-lue', 'sort' => 2],
            ['name_zh' => '使用答疑', 'name_en' => 'FAQ', 'slug' => 'shi-yong-da-yi', 'sort' => 3],
            ['name_zh' => '公司动态', 'name_en' => 'Company News', 'slug' => 'gong-si-dong-tai', 'sort' => 4],
        ])->map(
    ...
    /**
     * 标签（前两个与 SiteDemoSeeder 共用 slug，按 slug 取用已存在的行）
     *
    ...
    protected function tags(): Collection
    {
        return collect([
            ...
            ['name_zh' => '照明设计', 'name_en' => 'Lighting Design', 'slug' => 'lighting-design'],
            ['name_zh' => '家庭安防', 'name_en' => 'Home Security', 'slug' => 'home-security'],
            ['name_zh' => '竣工验收', 'name_en' => 'Acceptance', 'slug' => 'acceptance'],
        ])->map(
    ...
    protected function articlesData(Collection $categories): array
    {
        ...
        return [
            [
                ...
                'title_en'     => 'When to Bring in Your Smart Home Installer',
            ...
            [
                ...
                'title_en'     => 'Can Cameras Replay Without a Memory Card',
            ...
            [
                'title_zh'     => '网关选单模还是双模',
                'title_en'     => 'Single-Protocol or Dual-Protocol Gateway',
            ...
            [
                ...
                'title_en'     => 'Lighting Design Is Arithmetic Before Aesthetics',
            ...
            [
                ...
                'title_en'     => 'Do You Still Need Ethernet in a Wireless Smart Home',
            ...
            [
                ...
                'title_en'     => 'One Motor for a 4-Metre Curtain',
            ...
            [
                ...
                'title_en'     => 'Smart Lock Buying Pitfalls',
            ...
            [
                'title_zh'     => '语音控制到底实用吗',
                'title_en'     => 'Is Voice Control Actually Useful',
            ...
            [
                ...
                'title_en'     => 'Smart Home Handover Checklist',
            ...
            [
                ...
                'title_en'     => 'Service Coverage Around Wuhan',
            ...
            [
                ...
                'title_en'     => 'H1 Product Selection Review (Draft)',
