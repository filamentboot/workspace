 ...
 * active_theme 默认 'decoration'（科技装修浅色主题）。
 */
return new class extends SettingsMigration
{
    public function up(): void
    {
        // 公司名称（中文）。默认空串，理由见 SiteSettings::$company_name_zh —— 装上包
        // 不该凭空多出一个公司主体。add() 幂等，已填值的站点不受影响。
        $this->migrator->add('site.company_name_zh', '');
