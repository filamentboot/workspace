 ...
 * 创建资讯分类表
 *
 * 结构与案例分类、产品分类表一致，首版扁平，parent_id 预留。
 */
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('site_news_categories')) {
            return;
        }

        Schema::create('site_news_categories', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('site_news_categories');
    }
};
