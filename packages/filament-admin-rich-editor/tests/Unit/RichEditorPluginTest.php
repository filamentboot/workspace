 ...
 *
 * 验证：
 * - plugin_id 与 slug 保持一致（'filament-admin-rich-editor'）
...
class RichEditorPluginTest extends TestCase
{
     ...
     *
     * RichEditorPlugin::getId() 必须返回 'filament-admin-rich-editor'，
    ...
    public function test_plugin_id_matches_slug(): void
    {
        ...
        self::assertSame('filament-admin-rich-editor', $plugin->getId());
    }
