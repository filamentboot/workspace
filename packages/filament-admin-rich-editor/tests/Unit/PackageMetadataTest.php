...
namespace LaravelStack\FilamentAdminRichEditor\Tests\Unit;
 ...
 * 富文本编辑器包元信息测试
 *
 * 锁死 packages/filament-admin-rich-editor/composer.json 的关键字段：
 * - extra.filament-admin.slug 与 getId() 保持一致
...
class PackageMetadataTest extends TestCase
{
    ...
    public function test_extra_filament_admin_has_required_fields(): void
    {
        ...
        self::assertSame('filament-admin-rich-editor', $meta['slug']);
    }
    ...
    public function test_laravel_provider_is_declared(): void
    {
        ...
        self::assertContains(
            'LaravelStack\\FilamentAdminRichEditor\\RichEditorServiceProvider',
            $providers,
        );
    }
