...
/**
 * 生成 Filamentboot FeatureTest stub 命令（FEAT-03 / D-28 薄包装）
 *
 ...
 *
 * 使用示例：
 *   php artisan make:filamentboot-test Product
 *   php artisan make:filamentboot-test Product --force
 */
class MakeFilamentbootTestCommand extends Command
{
    /**
     * 命令签名
     *
     * @var string
     */
    protected $signature = 'make:filamentboot-test
     ...
     * @var string
     */
    protected $description = '生成 Filamentboot FeatureTest stub 到用户项目（FEAT-03）';
