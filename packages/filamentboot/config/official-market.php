...
return [
    'entries' => [
        ...
        [
            ...
            'installation' => [
                'instructions' => '当前先按安装指引手动接入，后续发布为官方可信来源后再开放后台安装。',
                'command'      => 'composer require filamentboot/huawei-cloud-sms',
            ],
        ],
        [
            'slug'         => 'crm-suite',
            'display_name' => 'CRM 套件',
            'package_name' => 'filamentboot/crm-suite',
            ...
            'installation' => [
                ...
                'command'      => 'composer require filamentboot/crm-suite',
            ],
        ],
        [
            'slug'         => 'corporate-site-suite',
            'display_name' => '企业官网',
            'package_name' => 'filamentboot/corporate-site-suite',
            'kind'         => 'solution_plugin',
            'source'       => 'official_listed',
            'version'      => '0.1.0',
            'author_name'  => 'Filamentboot',
            ...
            'installation' => [
                'instructions' => '当前作为官方收录方案型插件展示，先提供兼容信息与安装指引，不开放后台一键安装。',
                'command'      => 'composer require filamentboot/corporate-site-suite',
            ],
        ],
    ],
];
